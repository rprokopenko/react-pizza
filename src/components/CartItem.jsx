...
const CartItem = ({ id, name, type, size, totalPrice, totalCount, onRemove, onPlus, onMinus }) => {
  ...
  const handeleRemoveClick = () => {
    onRemove(id)
  }

  const handelePlusClick = () => {
    onPlus(id)
  }


  const handeleMinusClick = () => {
    onMinus(id)
  }
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <div onClick={handeleMinusClick} className="button button--outline button--circle cart__item-count-minus">
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
        ...
        <b>{totalCount}</b>
        <div onClick={handelePlusClick} className="button button--outline button--circle cart__item-count-plus">
      ...
      <div className="cart__item-remove">
        <Button onClick={handeleRemoveClick} className="button--circle" outline>
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
